...
result. Latency, whether a strike feels solid or thin, whether a timbre change
is audible or merely present in the maths: none of it appears in a test suite.

So, for this week only, the order inverts. **A listenable prototype comes
before visuals, before layout, before polish.** No check stands in for
listening, and no amount of green justifies shipping something I have not
played. The checks protect the page from being broken; they cannot tell me it
is any good.
